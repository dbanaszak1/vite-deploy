  ...
  return (
   <>
    <div className="w-5/6 max-w-[1280px] m-auto flex place-content-evenly flex-wrap flex-shrink border-t-2">
         ...
         <div className='h-56 md:h-80 w-full md:w-5/6 2xl:h-80 2xl:w-[585px] my-4'>
      ...
      <div className="w-5/6 max-w-[1280px] m-auto flex place-content-evenly flex-wrap flex-shrink md:mt-10">
