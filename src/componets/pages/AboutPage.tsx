  ...
  return (
    <div className=''>
      <div className='w-5/6 lg:w-2/3 m-auto justify-center'>
        <div className='w-full text-center text-4xl py-10 font-semibold'>
            <span>About the website</span>     
            <div className="justify-center m-auto w-40 my-4"><img src="https://github.com/dbanaszak1/vite-deploy/blob/main/public/images/logo-black.png?raw=true" className="rounded-full mx-2"></img></div>         
            <div className='text-xl lg:w-1/3 m-auto'>            
            ...
            <div className="w-full text-center text-4xl py-4 font-semibold mt-10">Tech</div>
            <div className='lg:inline-flex text-[90px] '>
              ...
              <div className='h-20 lg:h-32 w-16 flex items-center m-auto'>+</div>
              ...
              <div className='h-20 lg:h-32 flex items-center m-auto w-16'>+</div>
        ...
        <div>
          <div className='w-full text-center text-4xl mb-4 mt-10 font-semibold'>
              <span>About me</span>
          </div>
          <div>
            ...
            <div className='text-xl lg:w-1/3 m-auto text-center py-4'>I study Computer Science at the Faculty of Mathematics and Computer Science of Adam Mickiewicz University. I am actively developing and gaining experience at my university. For over a year I work as a freelancer creating my personal projects.
