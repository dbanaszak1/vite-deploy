    ...
    <div className='bg-gray-800'>
      <div className='w-5/6 lg:w-2/3 m-auto justify-center'>
        <div className='w-full text-center text-4xl py-10 font-semibold text-gray-200'>
            ...
            <div className="justify-center m-auto w-40 my-4"><img src="https://github.com/dbanaszak1/vite-deploy/blob/main/public/images/logo-no-background.png?raw=true" className="rounded-full mx-2"></img></div>         
